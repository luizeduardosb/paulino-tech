...
// ✅ Definindo a interface Estado para tipagem consistente
...
const Estado = () => {
  // ✅ objetoNovo tipado usando a interface Estado
  ...
  const [objetos, setObjetos] = useState<Estado[] | null>(null);
  ...
  const editObjeto = (obj: Estado) => {
    setObjeto({ ...obj });
    setObjetoDialog(true);
  }

  const confirmDeleteObjeto = (obj: Estado) => {
    setObjeto(obj);
...
const onInputChange = (e: React.ChangeEvent<HTMLInputElement>, name: keyof Estado) => {
      ...
      <div className="col-12">
        <div className="card">
          ...
          >
            ...
            <Column field="sigla" header="Sigla" body={siglaBodyTemplate} headerStyle={{ width: '14%', minWidth: '10rem' }} />
            <Column body={(rowData: Estado) => <ColunaOpcoes rowData={rowData} editObjeto={editObjeto} confirmDeleteObjeto={confirmDeleteObjeto} />} />
          </DataTable>
